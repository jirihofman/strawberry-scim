...
export default function Header({ children, packageInfo }) {
    const pjson = packageInfo || {
        description: 'Lightweight SCIM client with simple Bootstrap UI',
        version: '1.4.0',
        author: { name: 'Jiří Hofman', url: 'https://github.com/jirihofman' },
        repository: { url: 'https://github.com/jirihofman/strawberry-scim' },
                    ...
                    <div className='collapse navbar-collapse' id='navbarSupportedContent'>
                        <ul className='navbar-nav me-auto mb-2 mb-lg-0'>
                            <li className='nav-item'><a
                                href='https://github.com/jirihofman/strawberry-scim'
                                className='nav-link'
                                title='GitHub'
                                target='_blank'
